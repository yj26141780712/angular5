...
export class TimelyTemperature implements OnInit {
  ...
  getTemparature(callback){
    this.http.get(Global.domain+'api/deviceTemp.action?mid='+this.current_mid).subscribe((res:Response)=>{
      this.data=res.json().obj;
      //console.log(this.data);
      if(res.json().code==200)
      {
        this.current_temp={temp_0:"0",temp_1:"0",temp_2:"0",temp_3:"0",temp_4:"0",temp_5:"0",temp_6:"0",temp_7:"0"};
        this.current_temp.temp_0=res.json().obj.params[0].value;
        this.current_temp.temp_1=res.json().obj.params[1].value;
        this.current_temp.temp_2=res.json().obj.params[2].value;
        this.current_temp.temp_3=res.json().obj.params[3].value;
        this.current_temp.temp_4=res.json().obj.params[4].value;
        this.current_temp.temp_5=res.json().obj.params[5].value;
        this.current_temp.temp_6=res.json().obj.params[6].value;
        this.current_temp.temp_7=res.json().obj.params[7].value;
        //动态echart的数据
