    ...
    switch (this.roleName) {
      ...
      case "机械厂总经理":
        this.awesomeStr = [
          ...
          {
            i: "fa-file-text-o", title: "档案管理", list: [{ name: "注塑机管理", rounter: "Machine_M" }, { name: "片区管理", rounter: "area" }], color: "green"
          }];
        break;
      case "机械厂办事处":
        this.awesomeStr = [
          ...
          {
            i: "fa-file-text-o", title: "档案管理", list: [{ name: "注塑机管理", rounter: "Machine_M" }], color: "green"
          }];
        break;
      default:
        // code...
